...
export default function RefinedRedemptionSecurityVerificationPage() {
  return (
...
<div className="space-y-3"><div className="flex items-center gap-2 mb-1">
...
<input className="w-12 h-14 text-center text-xl font-bold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg focus:border-accent focus:ring-4 focus:ring-accent/20 outline-none text-slate-900 dark:text-white transition-all" maxLength={1} type="text" value="4"/>
<input className="w-12 h-14 text-center text-xl font-bold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg focus:border-accent focus:ring-4 focus:ring-accent/20 outline-none text-slate-900 dark:text-white transition-all" maxLength={1} type="text" value="5"/>
<input autoFocus className="w-12 h-14 text-center text-xl font-bold bg-white dark:bg-white/5 border-accent ring-4 ring-accent/20 outline-none text-slate-900 dark:text-white transition-all" maxLength={1} type="text"/>
<div className="flex items-center text-slate-300 dark:text-slate-600 font-bold">—</div>
<input className="w-12 h-14 text-center text-xl font-bold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg focus:border-accent focus:ring-4 focus:ring-accent/20 outline-none text-slate-900 dark:text-white transition-all" maxLength={1} type="text"/>
<input className="w-12 h-14 text-center text-xl font-bold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg focus:border-accent focus:ring-4 focus:ring-accent/20 outline-none text-slate-900 dark:text-white transition-all" maxLength={1} type="text"/>
<input className="w-12 h-14 text-center text-xl font-bold bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg focus:border-accent focus:ring-4 focus:ring-accent/20 outline-none text-slate-900 dark:text-white transition-all" maxLength={1} type="text"/>
</div>
<div className="flex justify-center mt-4">
<p className="text-slate-400 text-xs font-medium uppercase tracking-tight">Didn't receive code? <span className="text-slate-500">Resend in 0:59</span></p>
</div></div>
</div>
{/* Actions */}
<div className="p-6 bg-slate-50 dark:bg-white/5 flex flex-col sm:flex-row gap-3">
<button className="glare-sweep flex-1 bg-accent text-white py-4 rounded-lg font-bold uppercase tracking-widest text-sm shadow-lg shadow-accent/20 transition-all active:scale-[0.98] hover:shadow-accent/40 hover:scale-[1.02] active:scale-[0.98]">Confirm &amp; Redeem</button>
