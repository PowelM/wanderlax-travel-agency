...
export default function ContactWanderluxFaqWithSearchPage() {
  return (
...
<span className="text-lg font-semibold tracking-tight">What is your bespoke booking process?</span>
...
<div className="group border border-white/5 bg-slate-900/20 rounded-xl overflow-hidden transition-all duration-300">
<button className="w-full flex items-center justify-between p-6 text-left hover:bg-white/5 transition-colors">
<span className="text-lg font-semibold tracking-tight">Do you provide fully custom itineraries?</span>
<span className="material-symbols-outlined group-hover:text-primary transition-colors">add</span>
</button>
...
<div className="group border border-white/5 bg-slate-900/20 rounded-xl overflow-hidden transition-all duration-300">
<button className="w-full flex items-center justify-between p-6 text-left hover:bg-white/5 transition-colors">
<span className="text-lg font-semibold tracking-tight">What is your luxury cancellation policy?</span>
<span className="material-symbols-outlined group-hover:text-primary transition-colors">add</span>
</button>
<div className="hidden px-6 pb-6 text-slate-400 leading-relaxed">
...
<div className="group border border-white/5 bg-slate-900/20 rounded-xl overflow-hidden transition-all duration-300">
<button className="w-full flex items-center justify-between p-6 text-left hover:bg-white/5 transition-colors">
<span className="text-lg font-semibold tracking-tight">Do you handle visa and documentation assistance?</span>
<span className="material-symbols-outlined group-hover:text-primary transition-colors">add</span>
</button>
<div className="hidden px-6 pb-6 text-slate-400 leading-relaxed">
...
<div className="group border border-white/5 bg-slate-900/20 rounded-xl overflow-hidden transition-all duration-300">
<button className="w-full flex items-center justify-between p-6 text-left hover:bg-white/5 transition-colors">
<span className="text-lg font-semibold tracking-tight">Can you manage corporate group retreats?</span>
<span className="material-symbols-outlined group-hover:text-primary transition-colors">add</span>
</button>
<div className="hidden px-6 pb-6 text-slate-400 leading-relaxed">
