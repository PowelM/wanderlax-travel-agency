...
<button className="px-6 py-2 bg-primary text-white text-sm font-bold rounded-lg shadow-lg shadow-primary/20">All Saved</button>
<button className="px-6 py-2 text-slate-400 hover:text-slate-100 text-sm font-bold transition-colors">Private Jets</button>
<button className="px-6 py-2 text-slate-400 hover:text-slate-100 text-sm font-bold transition-colors">Villas</button>
</div>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
<div className="group relative flex flex-col rounded-2xl overflow-hidden bg-card-dark border border-primary/5 shadow-2xl transition-transform hover:-translate-y-2">
<div className="relative h-96 w-full bg-cover bg-center" data-alt="Bora Bora overwater bungalows crystal water" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAHDZw2P1Bt42QqK3S_ze8EGY_eGv8ylghIyD24u4tctGSvrm3TkZi7DTdX8k96quBef24tZEXLSw2m20GtGFi5Ag8QdytJo0u1UHOT5luYFRwTasxvpdOnjnaw45l_DSdmb5buDAY19_syqliRIKNq1QVMzjDw5hXX9Xcwo0DCf9YRg3Yo9QTnIf02G1y16jN5feXinGeao4CjtRdK1ZMNSVasRdK-RLDUXDSKqA55KiebzwSE1zFM8ZyMClE3iGDMTdjHCEk_YA')" }}>
<div className="absolute inset-0 bg-gradient-to-t from-card-dark via-transparent to-transparent opacity-80"></div>
<button className="absolute top-6 right-6 w-12 h-12 flex items-center justify-center rounded-full glass-panel text-primary hover:scale-110 transition-transform">
<span className="material-symbols-outlined fill-1">heart_minus</span>
</button>
<div className="absolute bottom-6 left-6 right-6">
<p className="text-primary font-bold text-xs uppercase tracking-[0.2em] mb-2">Oceania • Private Island</p>
<h3 className="text-3xl font-bold text-slate-100 leading-tight">The Brando Reserve</h3>
</div>
</div>
...
<p className="text-2xl font-bold text-slate-100">$24,900 <span className="text-sm font-normal text-slate-500">/ stay</span></p>
</div>
...
<p className="text-slate-500 text-xs uppercase font-medium">120 reviews</p>
</div>
</div>
...
<div className="group relative flex flex-col rounded-2xl overflow-hidden bg-card-dark border border-primary/5 shadow-2xl transition-transform hover:-translate-y-2">
<div className="relative h-96 w-full bg-cover bg-center" data-alt="Modern geometric architecture in Japanese mountains" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAJfQGGrlZ1FJuDxdSJqjTokju1EWXWtHli-FGMs1L38ktE0sA8i3rqQEPVhmSe-y211S0WrLDDiuwMB7F3MY9gdlInRaVBnGNmEAZgjLndTuplAYLpIeqKeA8TYY9lIgqjAmR1gLbhcciBrBv9ZWwScwywuqYsqPTV2LpSWmUXGtEcTQ4QXtxhEkaFrqvmUVFA8Ix688GLdZ2WS1_aptrJDgnH9jLcqg_ffI1a97RHgKy-4Rk_F32GnS6tofOtGQIWJbqcg4XNXw')" }}>
<div className="absolute inset-0 bg-gradient-to-t from-card-dark via-transparent to-transparent opacity-80"></div>
<button className="absolute top-6 right-6 w-12 h-12 flex items-center justify-center rounded-full glass-panel text-primary hover:scale-110 transition-transform">
<span className="material-symbols-outlined fill-1">heart_minus</span>
</button>
<div className="absolute bottom-6 left-6 right-6">
<p className="text-primary font-bold text-xs uppercase tracking-[0.2em] mb-2">Kyoto • Zen Experience</p>
<h3 className="text-3xl font-bold text-slate-100 leading-tight">Aman Kyoto Sanctuary</h3>
</div>
</div>
<div className="p-8 flex flex-col gap-6">
<div className="flex justify-between items-end">
<div>
<p className="text-slate-500 text-sm uppercase font-medium tracking-wide">Starting from</p>
<p className="text-2xl font-bold text-slate-100">$18,500 <span className="text-sm font-normal text-slate-500">/ stay</span></p>
</div>
<div className="text-right">
<div className="flex items-center gap-1 text-yellow-500 mb-1">
<span className="material-symbols-outlined text-sm fill-1">star</span>
...
<p className="text-slate-500 text-xs uppercase font-medium">85 reviews</p>
</div>
</div>
<button className="glare-sweep w-full bg-primary text-white py-4 rounded-xl font-extrabold uppercase tracking-widest text-sm hover:brightness-110 transition-all flex items-center justify-center gap-2">
                            Book Now <span className="material-symbols-outlined text-lg">arrow_right_alt</span>
...
<div className="group relative flex flex-col rounded-2xl overflow-hidden bg-card-dark border border-primary/5 shadow-2xl transition-transform hover:-translate-y-2">
<div className="relative h-96 w-full bg-cover bg-center" data-alt="Classic safari camp at sunset in Serengeti" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD-xCu15TkqE2gKjOy-5legZG_kg0k-seYoAyjTOJxAXXXWYZMHHxygiznrneGLQ9P_K3wpW-YOr8l_5HZ6etP9mDO8uJorzVhASmkxFlAz6BiwBiBwnfMlpp7mpgX1ego9SEcLS1AgD93gTapFSJO0WEXaFYyea1GikFOzLl2Obk4_kNbl15zalhbZuv6BwuOXoaTJZ092rPMCDBFvPOWta5RDPZ-cObH0RDMViIg9jPVa77kts7MyGQyI8FAZG8P-t8qxlHsePw')" }}>
<div className="absolute inset-0 bg-gradient-to-t from-card-dark via-transparent to-transparent opacity-80"></div>
<button className="absolute top-6 right-6 w-12 h-12 flex items-center justify-center rounded-full glass-panel text-primary hover:scale-110 transition-transform">
<span className="material-symbols-outlined fill-1">heart_minus</span>
</button>
<div className="absolute bottom-6 left-6 right-6">
<p className="text-primary font-bold text-xs uppercase tracking-[0.2em] mb-2">Tanzania • Ultra-Luxury Safari</p>
<h3 className="text-3xl font-bold text-slate-100 leading-tight">Singita Grumeti</h3>
</div>
</div>
<div className="p-8 flex flex-col gap-6">
<div className="flex justify-between items-end">
<div>
<p className="text-slate-500 text-sm uppercase font-medium tracking-wide">Starting from</p>
<p className="text-2xl font-bold text-slate-100">$32,000 <span className="text-sm font-normal text-slate-500">/ stay</span></p>
</div>
<div className="text-right">
<div className="flex items-center gap-1 text-yellow-500 mb-1">
<span className="material-symbols-outlined text-sm fill-1">star</span>
...
<p className="text-slate-500 text-xs uppercase font-medium">42 reviews</p>
</div>
</div>
<button className="glare-sweep w-full bg-primary text-white py-4 rounded-xl font-extrabold uppercase tracking-widest text-sm hover:brightness-110 transition-all flex items-center justify-center gap-2">
                            Book Now <span className="material-symbols-outlined text-lg">arrow_right_alt</span>
