...
export default function DownloadablePdfItineraryTemplatePage() {
  return (
    <div className="stitch-screen">
      <div className="max-w-[1000px] mx-auto bg-white min-h-screen shadow-2xl my-0 md:my-10 overflow-hidden relative border-t-8 border-primary">
{/* Header Section */}
...
<div className="relative w-full h-[450px] rounded-xl overflow-hidden bg-slate-200 shadow-lg">
<div className="absolute inset-0 bg-cover bg-center" data-alt="Breathtaking view of Positano colorful houses on the cliffside" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB5zq7PHMMOISVAeAOxxUZ0zjJDPOL6Cr0DVkGzVONkdXR_h9uQpXTf1gaEALWKPCoHDMr54x6PZ449NBTD6b6NUDMvNRNOegikYbcAJqC5veJwsFu1CJbCY9sLIJ5TGX6jCvW4ads7xgEvaznDDgkbV_mILcrzorYknH_yMkp7gi6P6QxkHWOccfcRdOQzPmHI2jfcmCGSda4dj0ded-zIZxVomCTUikbzUk5gH5PdNQp7an1cDR4uq2yh4oVGpVqizZo3OHRFWA')" }}></div>
...
<div className="px-8 md:px-16 mt-16 pt-16 border-t border-slate-100 pb-20">
...
<img alt="QR Code for digital itinerary" className="w-12 h-12" data-alt="QR code for online itinerary access" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDgUT1ZXQ1WPSGzTbSoXKRaePxboXYzi05Q1T1zTO164yDrCKttba3VnvWYtHtvORq4q_YETTnIfJgk5GzsgLPh3UTapXn2goVTFNujWm1UKi5vVfHe_EHVDdy7nu4-6gAHlogkdv_R37jVroQP9kCphA6KRPGQ_XEctCtOlW6dkhUm7ConGYVZcQFRcE9mG9GSGjEgdqzIGZBg40OtGA-TOOLge7fR_OqFti6QDJPSb1h7NApWYHzsO6KBbw-kkMY8oma4P1k96w"/>
</div>
</div>
</div>
...
<button className="no-print fixed bottom-8 right-8 bg-primary text-white p-4 rounded-full shadow-2xl hover:scale-105 transition-transform flex items-center justify-center" onClick={() => window.print()}>
