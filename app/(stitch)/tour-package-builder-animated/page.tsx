...
export default function TourPackageBuilderAnimatedPage() {
  return (
...
<h1 className="text-white text-3xl md:text-4xl font-black tracking-[-0.033em] char-reveal">Add New Tour Package</h1>
...
<section className="bg-[#271b1b] rounded-xl p-6 border border-[#392828] hover-lift">
<div className="flex items-center gap-3 mb-6">
<div className="bg-primary/20 p-2 rounded-lg text-primary">
<span className="material-symbols-outlined">info</span>
</div>
<h3 className="text-white text-xl font-bold char-reveal">1. Basic Information</h3>
</div>
...
<section className="bg-[#271b1b] rounded-xl p-6 border border-[#392828] hover-lift" id="section-2">
<div className="flex items-center justify-between mb-6">
<div className="flex items-center gap-3">
<div className="bg-primary/20 p-2 rounded-lg text-primary">
<span className="material-symbols-outlined">map</span>
</div>
<h3 className="text-white text-xl font-bold char-reveal">3. Itinerary Builder</h3>
</div>
...
<h3 className="text-white text-xl font-bold char-reveal">4. Media Gallery</h3>
</div>
...
<div className="relative aspect-video rounded-lg overflow-hidden group stagger-item">
...
{/* Pricing & Dates */}
<section className="bg-[#271b1b] rounded-xl p-6 border border-[#392828] sticky top-24 hover-lift">
<div className="flex items-center gap-3 mb-6">
<div className="bg-primary/20 p-2 rounded-lg text-primary">
<span className="material-symbols-outlined">payments</span>
</div>
<h3 className="text-white text-xl font-bold char-reveal">2. Pricing &amp; Dates</h3>
</div>
<div className="space-y-5">
<div>
...
<h3 className="text-white text-xl font-bold char-reveal">5. Inclusions</h3>
</div>
...
<button className="flex-1 sm:flex-none cursor-pointer items-center justify-center rounded-lg h-12 px-6 bg-[#392828] hover:bg-[#4a3535] text-white text-sm font-bold transition-colors btn-glare">
                    Save Draft
                </button>
<button className="flex-1 sm:flex-none cursor-pointer items-center justify-center rounded-lg h-12 px-8 bg-primary hover:bg-red-700 text-white text-sm font-bold shadow-lg shadow-primary/20 transition-all transform active:scale-95 btn-glare">
                    Publish Package
                </button>
</div>
</div>
