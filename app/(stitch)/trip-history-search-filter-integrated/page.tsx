...
export default function TripHistorySearchFilterIntegratedPage() {
  return (
...
<section className="mb-10 p-6 bg-white/5 dark:bg-card-dark/60 glass-effect rounded-2xl border border-slate-200 dark:border-border-dark flex flex-col xl:flex-row items-end gap-6">
<div className="flex-1 w-full space-y-2">
<label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 ml-1">Search</label>
<div className="relative">
<span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">search</span>
<input className="w-full pl-12 pr-4 py-3 bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-border-dark rounded-xl text-sm focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none transition-all placeholder:text-slate-500" placeholder="Search by destination or trip name" type="text"/>
</div>
</div>
<div className="w-full xl:w-auto flex flex-col md:flex-row gap-4 flex-shrink-0">
<div className="space-y-2">
<label className="text-[10px] font-bold uppercase tracking-widest text-slate-500 dark:text-slate-400 ml-1">Date Range</label>
<div className="flex items-center gap-2">
<input className="bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm text-slate-600 dark:text-slate-300 focus:ring-1 focus:ring-primary outline-none" type="date"/>
...
<select className="w-full bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-border-dark rounded-xl px-4 py-3 text-sm text-slate-600 dark:text-slate-300 focus:ring-1 focus:ring-primary outline-none appearance-none cursor-pointer">
<option>All</option>
...
<button className="mt-auto px-8 py-3 bg-primary text-white text-xs font-black uppercase tracking-widest rounded-xl shadow-lg shadow-primary/20 hover:bg-primary/90 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2">
