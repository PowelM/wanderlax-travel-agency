              ...
              <div className="flex flex-col gap-10">
                ...
                <article className="group relative flex flex-col lg:flex-row gap-8 bg-white dark:bg-card-dark rounded-2xl overflow-hidden border border-slate-200 dark:border-border-dark shadow-xl hover:border-primary/40 transition-all duration-500">
                  <div className="lg:w-2/5 h-64 lg:h-auto overflow-hidden relative">
                    ...
                    <Image fill alt="Amalfi Coast" className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 1024px) 100vw, 40vw" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA8yFgf6CPJSPp1CnNXdtrf-RFZeRCGjHN91Kgmu6Gno1ZypluJ4FF_xDCKPCK0KrDWZebpPEOb8EKy7zN54W9ypVKDkgBHHynrEZxuEn41TtE4Uus5CisLa8NfcwfGwkowFoypurxSAg6aKl6EaX_riNB4jPOBdxDbvFvE2H5dsxHki430La3MDFW4PPcZH6y_FxFobUMHTmm4jxc_AwJupjl5NlilBqrMsDSfya0lReF3h7g_JVTik41VivFvuFmvRTme0mL46Q"/>
                ...
                <article className="group relative flex flex-col lg:flex-row gap-8 bg-white dark:bg-card-dark rounded-2xl overflow-hidden border border-slate-200 dark:border-border-dark shadow-xl hover:border-primary/40 transition-all duration-500">
                  <div className="lg:w-2/5 h-64 lg:h-auto overflow-hidden relative">
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10"></div>
                    <Image fill alt="Venice" className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 1024px) 100vw, 40vw" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBNkTUOrEvi3TqD-98O6FwrVmngmvg8N0MRNXYNd5GbWLIHh7UR8XI9CUFFLxxqZwFPGK3YTpNZr1wxYkLPnkuhcJbdi_etzR9i1iQ4cSfCa3tpJiW69ElZLDSKJYtTtUc7pz91y0fHRaZ8wrsfOBeq5dg_wBUiq_5r0B0iDVsAqOa75PhoTTrnWASf9amYIKdoiQ5ViGWaiX3STa2p0CKQCaqCMqd35-fjmFDf2jwk13BSgKqKB1Bg90A2otkk9_EoHufxW-MQYQ"/>
                    <div className="absolute top-4 left-4 z-20">
                      <span className="px-3 py-1 bg-black/50 backdrop-blur-md text-white text-[10px] font-bold uppercase tracking-widest rounded-full border border-white/20">Italy</span>
                    </div>
                  </div>
                ...
                <article className="group relative flex flex-col lg:flex-row gap-8 bg-white dark:bg-card-dark rounded-2xl overflow-hidden border border-slate-200 dark:border-border-dark shadow-xl hover:border-primary/40 transition-all duration-500">
                  <div className="lg:w-2/5 h-64 lg:h-auto overflow-hidden relative">
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent z-10"></div>
                    <Image fill alt="India" className="object-cover transition-transform duration-700 group-hover:scale-110" sizes="(max-width: 1024px) 100vw, 40vw" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBpx9gPVij8yjf7celrnmKdQEhiAsrw-QS-Hfj6smq1rvab6NLJqP5ebhyJVQSgGr8XhsWPGKtU4-niVepLRc8D-ZragGa4EbNDpQ_xqqYb33865xXkv3eKWAumd6SdGAW84Y-1y-vD-6qaGYwHdKi4ESuBqJsIrR_G14ZXC1v2CNV9-lyroGROuJH7XdeDYzIVwuhWiES4DgO3zhBVE93mvAIsPMvh5QmBQO-reo0HsEruydNMfvfG46COctetONyYUH33noeAlA"/>
                    <div className="absolute top-4 left-4 z-20">
