...
export const allTours: Tour[] = [
  ...
  },
  {
    ...
    description: '12-day journey through Naples, Pompeii, and Positano with private Riva boat tours.',
    price: '$14,500',
    duration: '12 Days',
    group: 'Private / Max 6',
    rating: '4.9',
    category: ['All Packages', 'Cultural Tours'],
    tags: [{ label: 'Exclusive', style: 'bg-primary/90' }],
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCQxNSc6yTwVQTM1C6mk3mfrTqULXpTh6es9fCaGJbmjqZfhAcnl1eSPGQBWBlWTb6G1FcIBsvNJ-qxwp39kFMiTXDOHMYh3BhuBghZp5L9W9TYVJVeCK7kXaFEGynwXEuajV46qMdnxOEC_U6vezsLb2kphYTRi8bYMh_HTsIPRa2qgYx-BKF8jC_JicBCKBI4OXAt4-LTxuwBWYWKgBi0jRRSh63lm70aALbmM1-OulKR5bX3K5QeygIobgJibYLMviE8ZNSOVg'
  }
];
