...
export default function ContactWanderluxFaqWithCtaPage() {
  return (
...
</div><div className="mt-12 max-w-4xl p-8 rounded-2xl border border-white/5 bg-gradient-to-br from-slate-900/40 to-transparent backdrop-blur-sm relative overflow-hidden">
<div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full blur-3xl -mr-16 -mt-16"></div>
<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
<div className="text-center md:text-left">
<h4 className="text-2xl font-bold tracking-tight mb-2">Still have questions?</h4>
<p className="text-slate-400 text-sm leading-relaxed max-w-md">
                Our dedicated concierge team is available 24/7 to assist with your specific requirements and help craft your perfect journey.
            </p>
</div>
<div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
<a className="px-8 py-3 rounded-full border border-primary text-primary hover:bg-primary hover:text-white transition-all text-xs font-bold tracking-widest uppercase text-center" href="#">
                Contact Concierge
            </a>
</div>
</div>
